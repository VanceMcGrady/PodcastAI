      ...
      <div className="flex flex-col items-center">
        ...
        {hasContent && (
          <div className="w-full mb-6">
            ...
            <p className="text-gray-600 text-center mb-4 italic">{description}</p>
            
            <div className="relative mx-auto max-w-sm border border-gray-200 rounded-lg shadow-sm overflow-hidden">
              <div 
                className="absolute top-0 left-0 right-0 h-8 bg-gradient-to-b from-white to-transparent z-10"
              ></div>
              ...
              <div 
                className="absolute bottom-0 left-0 right-0 h-8 bg-gradient-to-t from-white to-transparent z-10"
              ></div>
